...
RUN apt-get update && apt-get install -y libcairo2-dev curl libssl-dev libcurl4-openssl-dev libproj-dev libgdal-dev libgeos-dev libssl-dev libgl1-mesa-dev libglu1-mesa-dev libudunits2-dev libxt-dev libv8-3.14-dev libssl-dev \
    && apt-get clean 
